...
(function(window, document, $, undefined) {
  $.swipebox = function(elem, options) {
    ...
    ui = {
       ...
       * @since 1.4.4.1 Added dailymotion support.
       */
      ...
      getVideo: function(url) {
        var iframe = '',
          ...
          dailymotionUrl = url.match(
            /(?:www\.)?dailymotion\.com\/video\/([a-zA-Z0-9\-_]+)/,
          ),
          dailymotionShortUrl = url.match(
            /(?:www\.)?dai\.ly\/([a-zA-Z0-9\-_]+)/,
          ),
          mp4Url = url.match(/.mp4/),
          twitchVideoUrl = url.match(
            /(?:www\.)?twitch\.tv\/videos\/([0-9a-zA-Z]+)/,
          ),
          twitchChannelUrl = url.match(
            /(?:www\.)?twitch\.tv\/([0-9a-zA-Z\_\-]+)/,
          ),
          metacafeUrl = url.match(
            /(?:www\.)?metacafe\.com\/watch\/([0-9a-zA-Z\_\-\/]+)/,
          ),
          qs = '';
        if (youtubeUrl || youtubeShortUrl) {
        ...
        } else if (dailymotionUrl || dailymotionShortUrl) {
          if (dailymotionShortUrl) {
            dailymotionUrl = dailymotionShortUrl;
          }
          iframe =
            '<iframe width="560" height="315" src="//www.dailymotion.com/embed/video/' +
            dailymotionUrl[1] +
            '"' +
            (plugin.settings.autoplayVideos ? ' allow="autoplay"' : '') +
            ' frameborder="0" allowfullscreen></iframe>';
        } else if (twitchVideoUrl) {
          iframe =
            '<iframe width="560" height="315" src="//player.twitch.tv/?video=' +
            twitchVideoUrl[1] +
            '"' +
            (plugin.settings.autoplayVideos ? ' allow="autoplay"' : '') +
            ' frameborder="0" allowfullscreen></iframe>';
          ...
          iframe =
            '<iframe width="560" height="315" src="//player.twitch.tv/?channel=' +
            twitchChannelUrl[1] +
            '"' +
            (plugin.settings.autoplayVideos ? ' allow="autoplay"' : '') +
            ' frameborder="0" allowfullscreen></iframe>';
          ...
          iframe =
            '<iframe width="560" height="315" src="//www.metacafe.com/embed/' +
            metacafeUrl[1] +
            '"' +
            (plugin.settings.autoplayVideos ? ' allow="autoplay"' : '') +
            ' frameborder="0" allowfullscreen></iframe>';
          ...
          iframe =
            '<video width="540" height="310" controls><source src="' +
            url +
